...
export class InsuranceService {
  private apiUrl = 'http://localhost:8089/api/insurance';
  ...
  getInsurancesByFarmer(farmerEmail: string): Observable<any> {
    return this.http.get(`${this.apiUrl}/farmer/policies?farmerEmail=${farmerEmail}`);
  }
  ...
  getFarmerInsurances(farmerEmail: string): Observable<any> {
    ...
    return this.http.get(`${this.apiUrl}/farmer/${currentUser.id}/policies`);
  }
  ...
  applyForInsurance(application: any): Observable<any> {
    ...
    return this.http.post(`${this.apiUrl}/apply?farmerEmail=${currentUser.email}`, application);
  }
  ...
  calculateInsurance(calculation: any): Observable<any> {
    return this.http.post(`${this.apiUrl}/calculate`, calculation);
  }
  ...
  fileClaim(claim: any): Observable<any> {
    ...
    return this.http.post(`${this.apiUrl}/claim?farmerEmail=${currentUser.email}`, claim);
  }

  // Get claims by farmer
  getClaimsByFarmer(farmerEmail: string): Observable<any> {
    return this.http.get(`${this.apiUrl}/farmer/claims?farmerEmail=${farmerEmail}`);
  }
  ...
  getPoliciesByStatus(status: string): Observable<any> {
    return this.http.get(`${this.apiUrl}/admin/policies?status=${status}`);
  }

  // Approve insurance
  approveInsurance(insuranceId: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/admin/policy/${insuranceId}/approve`, {});
  }

  // Reject insurance
  rejectInsurance(insuranceId: number, reason: string): Observable<any> {
    return this.http.post(`${this.apiUrl}/admin/policy/${insuranceId}/reject?reason=${reason}`, {});
  }

  // Get claims by status
  getClaimsByStatus(status: string): Observable<any> {
    return this.http.get(`${this.apiUrl}/admin/claims?status=${status}`);
  }

  // Approve claim
  approveClaim(claimId: number, approvedAmount: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/admin/claim/${claimId}/approve?approvedAmount=${approvedAmount}`, {});
  }

  // Reject claim
  rejectClaim(claimId: number, reason: string): Observable<any> {
    return this.http.post(`${this.apiUrl}/admin/claim/${claimId}/reject?reason=${reason}`, {});
  }

  // Process claim
  processClaim(claimId: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/admin/claim/${claimId}/process`, {});
  }
  ...
  getFarmerInsuranceStats(farmerEmail: string): Observable<any> {
    return this.http.get(`${this.apiUrl}/farmer/stats?farmerEmail=${farmerEmail}`);
  }

  // Get claim statistics
  getClaimStats(): Observable<any> {
    return this.http.get(`${this.apiUrl}/admin/claim-stats`);
  }
  ...
  getUserPolicies(farmerId: number): Observable<any> {
    ...
    return this.http.get(`${this.apiUrl}/farmer/policies?farmerEmail=${currentUser.email}`);
  }

  // Legacy method for backward compatibility
  getPendingClaims(): Observable<any> {
    return this.http.get(`${this.apiUrl}/admin/claims?status=pending`);
  }
  ...
  approveClaimLegacy(claimId: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/admin/claim/${claimId}/approve?approvedAmount=0`, {});
  }
  ...
  getClaimStatsLegacy(farmerId: number): Observable<any> {
    ...
    return this.http.get(`${this.apiUrl}/farmer/stats?farmerEmail=${currentUser.email}`);
  }
